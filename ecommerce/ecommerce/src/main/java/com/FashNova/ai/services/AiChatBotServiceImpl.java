...
import com.FashNova.mapper.OrderMapper;
import com.FashNova.mapper.ProductMapper;
...
import com.FashNova.repository.OrderRepository;
import com.FashNova.repository.ProductRepository;
import com.FashNova.repository.UserRepository;
import com.FashNova.response.ApiResponse;
import com.FashNova.response.FunctionResponse;
...
public class AiChatBotServiceImpl implements AiChatBotService {
    ...
    private JSONArray createFunctionDeclarations() throws JSONException {
...
//                Long productId = Long.parseLong(args.getString("productId"));
    ...
    public FunctionResponse getFunctionResponse(String prompt, Long productId, Long userId) throws ProductException, JSONException {
    ...
    @Override
    public ApiResponse aiChatBot(String prompt, Long productId, Long userId) throws ProductException, JSONException {
        String GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=" + GEMINI_API_KEY;
